...
7. The Zoho `Add_User` workflow runs server-side (password strength, uniqueness, default role assignment).
...
|---------------|------------------------|--------------|
| `Add_User` | `User` form — on create | Validates password strength, checks email uniqueness, assigns default role |
